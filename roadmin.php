...
<h2><marquee behavior="alternate">People Welfare System ROAD ADMIN</marquee></h2>	 


<form name="myForm" action="roadmin.php" autocomplete="on"autofocus="on"
onsubmit="return Validate()" method="post">

 

 <center> <div class="container">
 <img src="admin2.jpg" align="left" height="180" width="400">
 ...
 $name=$_POST['uname'];
 $pass=$_POST['pin'];
    $query=mysqli_query($con,"select * from login1 where username='$name'and password='$pass';");
